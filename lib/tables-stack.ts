...
export class TablesStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // 1. SOPFlow-Core (Single-Table Design)
    this.coreTable = new dynamodb.Table(this, 'SOPFlowCoreTable', {
      ...
      removalPolicy: cdk.RemovalPolicy.DESTROY, // Suitable for dev/MVP
    });

    // GSI-1: Employee Tasks
    ...
    // GSI-2: Task Status/Dashboard/Sweeper queries
    this.coreTable.addGlobalSecondaryIndex({
    ...
    // 2. SOPFlow-Auth (Authentication Profile and OTP Records)
    ...
    // 3. SOPFlow-Notifications (Notifications Log & Audit Trail)
